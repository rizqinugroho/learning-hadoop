...
public class SalesCounter extends Configured implements Tool {    
  enum Sales {
    SALES_DATA_MISSING
  }
  // Mapper
  ...
  public static void main(String[] args) throws Exception {
    int exitFlag = ToolRunner.run(new SalesCounter(), args);
  ...
  public int run(String[] args) throws Exception {
    ...
    Job job = Job.getInstance(conf, "SalesCounter");
